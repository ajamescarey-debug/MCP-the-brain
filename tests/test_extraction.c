...
SUITE(extraction) {
     ...
     * NOTE: the *_udl / *_routine / ensemble / self-call / type-inference /
     * macro-expand tests require the tree-sitter-objectscript grammar to be
     * linked. The grammar is vendored separately; until then these tests will
     * fail to link. The pure cbm_iris_export_to_udl transcoder and macro_table
     * unit assertions are grammar-free. */
